...
{
    /// <inheritdoc />
    public partial class UpdateGetItemsSP5 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = """
                ...
                BEGIN
                    ...
                    -- Adding Dynamic Ordering with Validation
                    IF @OrderBy NOT IN ('Name', 'Barcode', 'CategoryName', 'SellingTaxPercentage', 'Quantity', 'IsActive')
                    BEGIN
                        SET @OrderBy = 'Name'; -- Default order
                    END
